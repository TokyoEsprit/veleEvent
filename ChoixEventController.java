 ...
 * @author dell
 */
public class ChoixEventController implements Initializable {
    ...
    @FXML
    private void CompetitionClick(MouseEvent event) {
         try {
    ...
    @FXML
    private void SortieClick(MouseEvent event) {
         try {
